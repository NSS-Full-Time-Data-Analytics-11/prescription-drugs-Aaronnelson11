...
SELECT prescription.npi, nppes_provider_first_name AS first_name, nppes_provider_last_org_name AS last_name, specialty_description, 
...
SELECT 
	   CASE WHEN opioid_drug_flag = 'Y' THEN 'opioid'
	   		WHEN antibiotic_drug_flag = 'Y' THEN 'antibiotic'
			ElSE 'neither' END AS drug_type,
	   SUM(total_drug_cost) AS total_cost_by_type
